/*
  ...
  1. Tables
    ...
    - trucks
    - routes
    - route_stores (junction table for routes and stores)
...
-- Junction table for routes and stores
...
-- Repeat similar policies for stores
...
-- Repeat similar policies for trucks
...
-- Repeat similar policies for routes
...
-- Policy for route_stores
CREATE POLICY "Users can view their route stores"
  ON route_stores FOR SELECT
  TO authenticated
  USING (
    EXISTS (
